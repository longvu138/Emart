                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                        <div class="single-popular-items mb-50 text-center">
                                            ...
                                            <div class="popular-caption">
                                                <h3><a
                                                        href="">{{ \App\Models\Brand::where('id', $category->brand_id)->value('title') }}</a>
                                                </h3>
                                                <h3><a href="">{{ ucfirst( $category->title )}}</a></h3>
                                                @if ($category->offer_price)
                                                    <span> {{ number_format($category->offer_price, 2) }} VNĐ
                                                        <small>
                                                            <del class="text-danger">
                                                                {{ number_format($category->price, 2) }} VNĐ
                                                            </del>
                                                        </small>
                                                    </span>
                                                @else
                                                    <span> {{ number_format($category->price, 2) }} VNĐ </span>
                                                @endif
