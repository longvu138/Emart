...
@section('content')
    ...
    <div class="content-page">
        <div class="container-fluid">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                        <div>
                            ...
                            <h4 style="font-size: 20px" class="mb-3">{{ $title }} | Tổng :
                                {{ \App\Models\Brand::count() }} Brand</h4>
                        </div>
                        <a href="{{ route('brand.create') }}" class="btn btn-primary add-list"><i
                                                ...
                                                <div class="d-flex align-items-center list-action">
                                                    ...
                                                    <form method="POST"
                                                        ...
                                                        <a class="dlt badge bg-warning mr-2" data-toggle="tooltip"
                                                            data-id="{{ $brand->id }}" data-placement="top"
            ...
            {{ $brands->render('backend.layouts.paginate') }}
            <!-- Page end  -->
        </div>
